...
## Contents 
  ...
  6. [MLT.ipynb](MLT.ipynb) - Finally we touch upon another cutting edge topic, multi-task-learning, where by learning multiple outcomes we can strengthen the results of our learners. We introduce a simple and cheap approach to MTL specific to finance that we have developed. 
